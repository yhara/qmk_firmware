...
[LOWER] = KEYMAP(
    ...
    // right hand
       KC_NO  ,  KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  ,
       KC_NO  ,  KC_CIRC, KC_AMPR, KC_LPRN, KC_RPRN, KC_ASTR, KC_MINS,
                 KC_BSPC, KC_DQT , KC_LBRC, KC_RBRC, KC_QUOT, KC_NO  ,
       KC_NO  ,  KC_NO  , KC_PLUS, KC_LCBR, KC_RCBR, KC_UNDS, KC_UNDS,
                          KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  ,
       KC_NO  , KC_NO  ,
       KC_NO  ,
       KC_NO  , KC_NO  , KC_NO  
...
[RAISE] = KEYMAP(
    ...
    // right hand
       ...
       KC_NO  ,  KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , KC_BSPC,
                 KC_BSPC, KC_DOWN, KC_UP  , KC_RIGHT,KC_NO  , KC_NO,
