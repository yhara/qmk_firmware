...
CTL_T(KC_ESC),KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT, \
  ...
  KC_LCTRL,   KC_LALT, ADJUST,  KC_LGUI,  LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
),
...
[_LOWER] = KEYMAP( \
  ...
  _______, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_DQT,  KC_PLUS, S(KC_COMM),S(KC_DOT),S(KC_SLSH),S(KC_MINS), \
